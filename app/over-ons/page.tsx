...
export const metadata: Metadata = {
  title: 'Over Ons | StayCool Airco Kerkrade',
  description: 'Maak kennis met StayCool Airco - uw lokale specialist voor airconditioning installatie, onderhoud en reparatie in Kerkrade en omgeving. Ontdek onze expertise en persoonlijke aanpak.',
};
...
const features = [
  {
    ...
    description: 'Meer dan 10 jaar ervaring in airconditioning installatie in Kerkrade en omgeving.'
  },
  {
    icon: Award,
  ...
  },
  {
    ...
    description: 'Specialistische kennis van lokale regelgeving en historische panden in Kerkrade.'
  },
  {
    icon: ThumbsUp,
...
const additionalFeatures = [
  {
    ...
    description: 'Binnen 24 uur reactie op serviceverzoeken in de regio Kerkrade.'
  },
  {
    icon: ShieldCheck,
  ...
  return (
    <div className="container mx-auto px-4 py-12">
      ...
      <section className="mb-16">
        <h1 className="text-4xl font-bold mb-6">Over StayCool Airco Kerkrade</h1>
        <div className="prose max-w-none">
          <p className="text-xl mb-6 text-muted-foreground">
            Uw lokale specialist voor airconditioning in het unieke klimaat en de karakteristieke gebouwen van Kerkrade.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
            <div>
              <p className="mb-4">
                StayCool Airco is uw betrouwbare partner voor alle airconditioning oplossingen in Kerkrade en omgeving. 
                Als lokale specialist begrijpen we de unieke uitdagingen van het Kerkraadse klimaat en de karakteristieke 
                architectuur van de stad.
              </p>
              <p className="mb-4">
                Onze expertise strekt zich uit van moderne appartementen in het centrum tot monumentale panden in het historische 
                gedeelte. We bieden maatwerkoplossingen die perfect aansluiten bij de specifieke eisen van uw woning of bedrijfspand.
              </p>
              <p>
            ...
            <div className="bg-blue-50 p-6 rounded-lg">
              ...
              <ul className="space-y-2">
                <li className="flex items-start">
                  ...
                  <span>Kennis van lokale regelgeving en vergunningen in Kerkrade</span>
                </li>
                <li className="flex items-start">
                  <span className="text-blue-600 mr-2">✓</span>
                  <span>Ervaring met typische Kerkraadse gebouwen</span>
                </li>
                <li className="flex items-start">
                  <span className="text-blue-600 mr-2">✓</span>
      ...
      <section className="mb-16">
        <h2 className="text-3xl font-bold mb-8">Onze Diensten in Kerkrade</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white p-6 rounded-lg shadow-md border border-gray-100">
            <h3 className="text-xl font-semibold mb-4 text-blue-600">Airco Installatie</h3>
            <p className="mb-4">
              Professionele installatie van airconditioning systemen, perfect afgestemd op uw woning of bedrijf in Kerkrade. 
          ...
          <div className="bg-white p-6 rounded-lg shadow-md border border-gray-100">
            ...
            <p className="mb-4">
              Regelmatig onderhoud en snelle service voor alle merken airconditioners in Kerkrade. 
          ...
          <div className="bg-white p-6 rounded-lg shadow-md border border-gray-100">
            ...
            <p className="mb-4">
              Persoonlijk advies over de beste airconditioning oplossing voor uw situatie in Kerkrade. 
      ...
      <section className="bg-blue-50 p-8 rounded-lg mb-16">
        ...
        <p className="text-lg mb-4">
          Wij streven ernaar om hoogwaardige klimaatoplossingen toegankelijk te maken voor iedereen in Kerkrade en omgeving. 
        ...
        <p className="text-lg">
          ...
          welzijn van onze gemeenschap en het behoud van het unieke karakter van Kerkrade.
        </p>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <p className="mb-6">
                ...
                Onze Kerkraadse experts staan voor u klaar.
              </p>
            ...
            <div className="hidden md:block">
              <div className="rounded-lg overflow-hidden h-64">
                <iframe 
                  ...
                  title="StayCool Airco Kerkrade Bedrijfsvideo" 
                  frameBorder="0" 
